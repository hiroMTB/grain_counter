void ofApp::keyPressed(int key){
    ...
    switch(key){
        ...
        case OF_KEY_LEFT:
        {
            MoveCommand m(machine, MoveCommand::Axis::X, 0, cp, tp.x-1, xySpeed);
            m.call();
            break;
        }
        ...
        case OF_KEY_UP:
        {
            MoveCommand m(machine, MoveCommand::Axis::Y, 0, cp, tp.y+1, xySpeed);
            m.call();
            break;
        }
        ...
        case '[':
        {
            MoveCommand m(machine, MoveCommand::Axis::Z, 0, cp, tp.z+1, zSpeed);
            m.call();
            break;
        }
        case ']':
